# Polygon Range Search Algorithm 

This is a C++ implementation of an efficient spatial search algorithm that leverages KD-trees for rapid point-in-polygon queries. It utilizes the Approximate Nearest Neighbor (ANN) library to construct a KD-tree from a set of n two-dimensional points, enabling logarithmic-time spatial queries.
